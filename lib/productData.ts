...
export const buknuProduct: Product = {
  id: "buknu",
  name: "Artisan Ayurvedic Buknu",
  description: "A legendary 12-spice digestive blend. Handcrafted, stone-ground, and infused with cold-pressed mustard oil.",
  longDescription: "Buknu is an ancient Ayurvedic spice formulation that doubles as a digestive aid and a delicious seasoning. Originating in Northern India, our family recipe combines twelve handpicked therapeutic spices. Stone-ground in small batches to preserve volatile oils, Buknu is toasted in pure cold-pressed mustard oil to activate its digestion-enhancing properties. Perfect as a garnish, it brings a rich, earthy, salty, and tangy complexity to everyday meals.",
  ingredients: [
  ...
  image: "/images/buknu-jar.jpg", // We can use the product image later, we'll place a placeholder for now
  rating: 4.9,
  reviewsCount: 148,
  variants: [
    {
